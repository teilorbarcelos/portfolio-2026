        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="space-y-3">
              ...
              {personal.phone && <div className="flex items-center text-gray-700">
                <svg className="w-5 h-5 mr-3 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">O que eu faço</h3>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Desenvolvimento Web</h4>
                  <p className="text-gray-600">Criação de aplicações web modernas e responsivas</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-primary-600 rounded-lg flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Desenvolvimento de aplicativos mobile multiplataforma</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-primary-600 rounded-lg flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Criação de interfaces intuitivas e atraentes</p>
                </div>
              </div>
            </div>
          </div>
